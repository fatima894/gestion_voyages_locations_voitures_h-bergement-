...
<div class="d-flex justify-content-between mb-4">
    <h2> Appartements </h2>
    <button class="btn btn-success" id="createNewElement">Ajouter une nouvelle Appartement</button>
</div>
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'action', name: 'action', orderable: false, searchable: false},
               ...
               $('#modelHeading').html("Ajouter une nouvelle Appartement");  // هذا العنوان

               $("#form").attr("action", "/appartement/store"); // هنا وضعت الاكشن
              ...
              $.get('/appartement/edit/'+ house_info_id, function (data) {  // احضر البيانات

              $('#modelHeading').html("Modifier une Appartement");  //غير عنوان الفورم

              $("#form").attr("action", "/appartement/update/"+house_info_id);  // هنا وضعت الاكشن
              ...
              $("#Appartement-menu").attr("class", "nav-link active");
