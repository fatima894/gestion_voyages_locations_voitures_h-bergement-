...
class Travels_offersController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        ->get(['travel_offers.travel_offer_id','travel_offers.travel_id','travel_companies.company_name','to_airport.airport_name as t'
                ,'travel_details.travel_date','travel_details.price','travel_details.travel_time','from_city.city_name as from_city',
        'travel_offers.discount_percentage','to_city.city_name as to_city','directions.to_airport_id','travel_details.photo']);
